...
export default async function StudioPage() {
  ...
  const [{ count: members }, { count: results }, { count: sessions }, { count: leads }] = await Promise.all([
  ...
  return <main>
    <section className="pageHero compactHero dashboardHero"><p className="eyebrow">SHIFT LEFT STUDIO</p><h1>Admin workspace.</h1><p className="lead">Manage assessments, members, leads, content, resources, and platform operations. Only approved admins can access this area.</p></section>
