  ...
  return <main className="authPage">
    <section className="authCard">
      ...
      <div className="actions">
        <button className="button secondary" type="button" onClick={() => { setMode(mode === "signin" ? "signup" : "signin"); setError(""); setMessage(""); }}>{mode === "signin" ? "Create an account" : "I already have an account"}</button>
