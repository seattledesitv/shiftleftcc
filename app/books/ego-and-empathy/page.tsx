  ...
  return <main className="bookPage">
    ...
    <section className="bookHero">
      ...
      <div className="bookHeroCopy">
        ...
        <div className="bookActions"><Link className="button primary" href={checkoutUrl}>Buy Now</Link></div>
        <p className="purchaseNote">Secure direct checkout is handled through Stripe. Card details are never stored by Shift Left.</p>
      </div>
    </section>
    ...
    <section className="bookFinalCta"><p className="eyebrow">START READING</p><h2>Explore the balance between self-belief and understanding others.</h2><div className="bookActions centered"><Link className="button primary" href={checkoutUrl}>Buy Now — $19.99</Link></div></section>
  </main>;
}
