...
export default async function MyJourneyPage() {
  ...
  return <main>
    <section className="pageHero compactHero dashboardHero"><p className="eyebrow">MY JOURNEY</p><h1>Welcome back.</h1><p className="lead">Your private space for mission, vision, life goals, gratitude, assessments, activity, progress, reflection, and event tickets.</p></section>
    <nav className="journeyNav" aria-label="My Journey navigation"><Link href="/my-journey">Home</Link><Link href="/my-tickets">My Tickets</Link><Link href="/my-journey/foundation">Mission & Vision</Link><Link href="/my-journey/vision-board">Vision Board</Link><Link href="/my-journey/goals">Life Goals</Link><Link href="/my-journey/gratitude">Gratitude</Link><Link href="/my-journey/assessments">Assessments</Link><Link href="/my-journey/progress">Progress</Link><Link href="/my-journey/journal">Journal</Link><Link href="/my-journey/activity">Activity</Link><Link href="/resources">Resources</Link><Link href="/book">Coaching</Link></nav>
    <section className="memberDashboard"><div className="dashboardGrid">
      ...
      <article className="dashboardCard"><p className="eyebrow">MY TICKETS</p><h2>Your event registrations in one place.</h2><p>Open tickets purchased or registered using your account email.</p><Link className="button secondary" href="/my-tickets">View my tickets</Link></article>
