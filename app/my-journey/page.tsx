...
export default async function MyJourneyPage() {
  ...
  const [{ data: latestResult }, { data: activeSession }, { count: completedCount }, { count: activityCount }, { count: goalCount }, { count: gratitudeCount }, { data: mission }, { data: vision }] = await Promise.all([
