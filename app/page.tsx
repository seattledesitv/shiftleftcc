...
const logoDetails = [
  ["green", "The green figure", "Represents an individual equipped with self-awareness, resilience, empathy, and practical mental-health strategies."],
  ["blue", "The blue figure", "Represents an individual still discovering tools and support on their wellbeing journey."],
  ...
  ["balance", "The balance", "Balancing wellbeing and action to create a fulfilling, meaningful life."],
];
  ...
  return (
    <main>
      <section className="hero">
        <div className="heroCopy">
          ...
          <div className="actions">
            <a href="#contact" className="button primary">Book a Discovery Call</a>
            <a href="#about" className="button secondary">Learn More</a>
          </div>
        </div>
        <div className="heroRight" aria-label="Awareness, empowerment and action">
          <div className="pillar"><span className="pillarIcon">♡</span><strong>Awareness</strong><p>Build self-awareness and understand what truly matters.</p></div>
          <div className="pillar"><span className="pillarIcon">◎</span><strong>Empowerment</strong><p>Strengthen mindset, develop skills, and grow resilience.</p></div>
          <div className="pillar"><span className="pillarIcon">↗</span><strong>Action</strong><p>Take proactive steps today to create a better tomorrow.</p></div>
        </div>
      </section>
      ...
      <section className="logoStory" id="logo-story">
        <div className="logoStoryHeader"><p className="eyebrow">WHY THIS LOGO?</p><h2>A visual story of the Shift Left philosophy.</h2><p>Our identity reflects the belief that wellbeing is a continuous journey—one we take together.</p></div>
        ...
        <div className="brandPromise"><span>♡</span><p><strong>Shift Left Coaching</strong> helps individuals, families, schools, and organizations build the skills today for a <em>healthier, stronger tomorrow.</em></p><div><b>Mind.</b><b>Heart.</b><b>Action.</b></div></div>
      </section>
