...
export default function HomePage() {
  return <main>
    ...
    <section className="consultingTeaser"><p className="eyebrow">SHIFT LEFT CHECK-IN</p><h2>Before choosing a program, understand where you are today.</h2><p>Reflect on six practical areas—awareness, learning, care, support, action, and sustainability—and receive a simple recommended next step.</p><div className="actions"><Link href="/assessment" className="button primary">Take the 5-minute check-in</Link><Link href="/resources" className="button secondary">Explore free resources</Link></div></section>
