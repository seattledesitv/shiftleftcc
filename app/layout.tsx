  ...
  return <html lang="en"><body>
    <header className="siteHeader">
      ...
      <nav aria-label="Main navigation">
        ...
        {user && <Link href="/my-journey">My Journey</Link>}
        {isAdmin && <Link href="/studio">Studio</Link>}
