...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="en"><body>
    ...
    <footer>
      ...
      <div><strong>Explore</strong><Link href="/programs">Programs</Link><Link href="/organizations">Organizations</Link><Link href="/consulting">Consulting</Link><Link href="/speaking">Speaking</Link><Link href="/blog">Journal</Link><Link href="/resources">Resources</Link></div>
